...
<body>
	...
	<%
		...
		int id = Integer.parseInt(request.getParameter("id")) ;      //string을 int로 넘김
		...
		*/
		...
		sql = "select * from freeboard where id = ?"; 				//?에 id값이 들어감.
   ...
   <table width="600" border="0" cellpadding="0" cellspacing="5" align="center">
	<tr> 
		...
		<td width="70" align="right">
			<A href="freeboard_del.jsp?id=<%= id %>&page=<%= request.getParameter("page") %>">			<!-- ?에 또 id값을 받아와서 del.jsp로 감 -->
