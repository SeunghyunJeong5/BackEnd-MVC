...
<%
	//세션에 저장된 변수의 값을 불러옴
	BoardDTO board = (BoardDTO) session.getAttribute("board");		// "board"에는 dto가 저장되어있음. 이걸 끄집어내와야함. 다운캐스팅을해서...
...
<body>
		<div>
			...
			<form action = "updateBoard.do" method="post">
				...
				<!-- 글 수정시 seq 변수 값을 서버로 전송 ... seq를 받아와서 다시 서버로 전송...-->
				<input type = "hidden" name ="seq" value ="<%=board.getSeq()%>">
				<input type = "hidden" name ="write" value ="<%=board.getWrite()%>"> <!-- 자기글만 수정가능하게 -->
